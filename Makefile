...
libc:
	...
	gcc -c src/libc_extended/libc_extended.c -o bin/libc_extended/libc_extended.o
...
compile:
	gcc -c test.s -o bin/test.o
	gcc -no-pie -o test bin/test.o -L./bin/libc_extended -llibc_extended