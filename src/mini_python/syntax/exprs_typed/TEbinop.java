...
public class TEbinop extends TExpr {
    ...
    public TEbinop(Binop op, TExpr e1, TExpr e2, Span span) throws InvalidBinopTypesException {
        ...
        if (this.getType() == null) {
            throw new InvalidBinopTypesException(span, op, this.e1.getType(), this.e2.getType());
        }
    }
